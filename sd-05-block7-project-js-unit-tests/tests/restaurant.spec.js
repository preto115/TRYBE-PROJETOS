...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    // assert.fail();
   const food = {'coxinha': 3.90, 'sanduiche': 9.90};
   const drink = {'agua': 3.90, 'cerveja': 6.90};
    ...
    // {'pastel': 5.5}, {'agua': 3.90}), "drink": {"agua": 3.9}, "food": {"pastel": 5.5}
    ...
    assert.deepStrictEqual(createMenu(food, drink), {"fetchMenu": {food:{'pastel': 5.5}, drink:{'agua': 3.9}}});
    // const objetoRetornado = createMenu(objetoQualquer);
